...
int main()
{
    ...
    int scores4[SIZE] = {0, 80, 60, 100, 60};
    printf("データサイズ: %d\n", SIZE);
    QSort(scores4, 0, SIZE - 1);
    showData(scores4, SIZE);

    printf("データサイズ: %d\n",OTHER_SIZE);
    int scores5[OTHER_SIZE] = {10, 20, 30, 40, 50, 60};
    QSort(scores5, 0, OTHER_SIZE - 1);
    showData(scores5, OTHER_SIZE);
